...
(defineTerm "diastereomer*" ':DefinableThing)
...
(defineTerm "isotope*" ':DefinableThing)
(defineTerm "isotopic abundance*" ':DefinableThing)
;;;J
...
;;;R
(defineTerm "relative atomic mass*" ':DefinableThing)
(defineTerm "relative energy*" ':DefinableThing)
(defineTerm "relative isotopic mass*" ':DefinableThing)
(defineTerm "relative molecular mass*" ':DefinableThing)
;;;S
