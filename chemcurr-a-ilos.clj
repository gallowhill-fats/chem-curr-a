...
;; 4. Calculate the relative atomic mass of an element given the relative abundances of its isotopes, or its mass spectrum.
 ...
 (assert '(ILOQualifier (CalculateILO (ValueOf (NamedQuantityOfClass "relative atomic mass*" "element class*"))) (Given (Data "isotopic relative abundance*"))))
(assert '(ILOQualifier (CalculateILO (ValueOf (NamedQuantityOfClass "relative atomic mass*" "element class*"))) (Given "mass spectrum*")))
 ...
 (assert '(Isa (PerformILO (every x (Isa x Act) (Isa x "molarity calculation class*") (Involves x (Data "gas volume*")))) "ILO class*"))
 (assert '(Isa (PerformILO (every x (Isa x Act) (Isa x "molarity calculation class*") (Involves x (Data "reacting mass*")))) "ILO class*"))
 (assert '(Isa (PerformILO (every x (Isa x Act) (Isa x "molarity calculation class*") (Involves x (setof (Data "volume*") (Data "concentration*"))))) "ILO class*"))
